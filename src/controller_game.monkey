...
Global currentDepth: Int
Global currentLevel: Int
Global currentZone: Int
Global dailyChallengeSuccessScore: Int
Global DEBUG_ALL_TILES_VISIBLE: Int
Global DEBUG_GOD_MODE: Int
Global DEBUG_HOTKEY_MODE: Int
Global DEBUG_HOTKEY_TEXT: Int
...
Global gamePaused: Int
Global hardcoreModeSuccessScore: Int
Global hasWon: Int
...
Global speedrunSuccessScore: Int
